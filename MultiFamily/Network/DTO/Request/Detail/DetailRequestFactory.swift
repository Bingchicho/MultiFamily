...
struct DetailRequestFactory: DetailRequestFactoryProtocol {
    ...
    func makeRegistryUpdateRequest(thingName: String, name: String?, autoLockOn: Bool?, autoLockTime: Int?, beepOn: Bool?, power: Int?, adv: Int?) -> RegistryUpdateRequestDTO {
        RegistryUpdateRequestDTO(applicationID: env.applicationID, thingName: thingName, clientToken: device.clientToken, overwrite: true, taskID: device.clientToken, status: "started", userName: nil, name: name, installationNotComplete: nil, bt: nil, attributes: DeviceAttributesDTO(location: nil, direction: nil, accessCode: nil, preamble: nil, virtualCode: nil, twoFA: nil, vacationMode: nil, autoLock: autoLockOn ?? false ? "T": "F", autoLockDelay: autoLockTime, autoLockDelayMin: nil, autoLockDelayMax: nil, operatorVoice: beepOn ?? false ? "T" : "F", voiceType: nil, voiceValue: nil, showFastPassageMode: nil, sabbathMode: nil, voiceLanguage: nil, voiceLanguageSupport: nil, timezone: nil, mcuVersion: nil, bleTXPower: power, bleAdv: adv, battery: nil, updateAt: nil))
    }
